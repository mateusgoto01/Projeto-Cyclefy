...
void setup() {
  ...
  calibrationValue_1 = ; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = ; // uncomment this if you want to set this value in the sketch
